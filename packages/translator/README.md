...
```ts
import type { TranslateResolver } from 'payload-translator/resolvers/types';
...
```ts
import { translateOperation } from 'payload-translator';
...
This plugin is derived from [r1tsuu/payload-plugin-translator](https://github.com/r1tsuu/payload-plugin-translator) (MIT), with additional resolvers and updates for Payload 3.x.
